...
public class UsuarioDAO extends DAO {
	...
	public boolean insert(Usuario usuario) {
		...
		try {  
			...
			st.close();
			status = true;
			System.out.println("\n Usuário " + usuario.getLogin() + " foi cadastrado com sucesso");
	...
	public boolean update(Usuario usuario) {
		...
		try {  
			...
			st.close();
			status = true;
			System.out.println("\n Usuário " + usuario.getLogin() + " foi atualizado com sucesso");
		} catch (SQLException u) {  
			throw new RuntimeException(u);
		}
		return status;
	...
	public boolean delete(int codigo, Usuario usuario) {
		boolean status = false;
		try {  
			Statement st = conexao.createStatement();
